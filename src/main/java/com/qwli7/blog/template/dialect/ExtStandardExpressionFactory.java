...
import com.qwli7.blog.template.expression.Dates;
import com.qwli7.blog.template.expression.Pages;
...
public class ExtStandardExpressionFactory implements IExpressionObjectFactory {
    ...
    private static final Set<String> ALL_EXPRESSION_OBJECT_NAMES = Collections.unmodifiableSet(
            new HashSet<>(Arrays.asList(PAGE_EVALUATION_VARIABLE_NAME, DATE_EVALUATION_VARIABLE_NAME))
    );
